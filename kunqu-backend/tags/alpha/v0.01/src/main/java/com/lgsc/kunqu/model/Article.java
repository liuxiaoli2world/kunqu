...
public class Article {
     ...
     * 标题
     */
    @ApiModelProperty(value = "标题，最大长度：50。")
     ...
     * 作者
     */
    @ApiModelProperty(value = "作者，最大长度：20。")
    @Length(min = 0, max = 20)
     ...
     * 来源
     */
    @ApiModelProperty(value = "来源，最大长度：20。")
    @Length(min = 0, max = 20)
     ...
     * 阅读排行 0 否 1 是
     */
    @ApiModelProperty(value = "阅读排行 0 否 1 是")
     ...
     * 精品阅读 0 否 1 是
     */
    @ApiModelProperty(value = "精品阅读 0 否 1 是")
    @Digits(integer = 1, fraction = 0)
     ...
     * 首页推荐阅读 0 否 1 是
     */
    @ApiModelProperty(value = "首页推荐阅读 0 否 1 是")
    @Digits(integer = 1, fraction = 0)
     ...
     * 内容
     */
    @ApiModelProperty(value = "内容，最大长度：50000。")
	@NotBlank(message = "内容不能为空！")
    @Length(min = 0, max = 50000)
     ...
     * 列表精品推荐 0 否 1 是
     */
    @ApiModelProperty(value = "列表精品推荐 0 否 1 是")
    @Digits(integer = 1, fraction = 0)
