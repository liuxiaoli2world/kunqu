...
@RestController
@RequestMapping("/kunqu/repertoiretag")
public class RepertoireTagController {
	...
	public Response select(@ApiParam(value = "剧目标签id", required = true) @PathVariable("repertoireTagId") Long repertoireTagId) {
	...
	public Response delete(@ApiParam(value = "剧目标签id", required = true) @PathVariable("repertoireTagId") Long repertoireTagId) {
		Response response = new Response();
